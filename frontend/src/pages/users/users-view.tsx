    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.grades_student &&
                      Array.isArray(users.grades_student) &&
                      users.grades_student.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
          ...
          <>
            <p className={'block font-bold mb-2'}>Meetings Counselor</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.meetings_counselor &&
                      Array.isArray(users.meetings_counselor) &&
                      users.meetings_counselor.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
                              `/meetings/meetings-view/?id=${item.id}`,
                            )
                          }
                        >
              ...
              {!users?.meetings_counselor?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Meetings Student</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.meetings_student &&
                      Array.isArray(users.meetings_student) &&
                      users.meetings_student.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
