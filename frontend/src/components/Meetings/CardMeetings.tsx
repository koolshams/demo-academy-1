...
const CardUsers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_MEETINGS');
              ...
              >
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    ...
                    onEdit={onEdit}
                    itemId={item.id}
                    pathEdit={`/meetings/meetings-edit/?id=${item.id}`}
                    pathView={`/meetings/meetings-view/?id=${item.id}`}
