module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('meetings', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('grades', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('meetings', 'studentId', {
        transaction,
      });

      await queryInterface.removeColumn('meetings', 'counselorId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('grades', 'courseId', { transaction });

      await queryInterface.removeColumn('grades', 'studentId', { transaction });

      await queryInterface.removeColumn('grades', 'value', { transaction });
