...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.grades_student = await users.getGrades_student({
      transaction,
    });

    output.meetings_counselor = await users.getMeetings_counselor({
      transaction,
    });

    output.meetings_student = await users.getMeetings_student({
      transaction,
    });
